// Actions
const FETCH_ADD_INTERFACE_INPUT = '/addInterface/FETCH_ADD_INTERFACE_INPUT';
const FETCH_ADD_INTERFACE_TAG_VALUE = '/addInterface/FETCH_ADD_INTERFACE_TAG_VALUE';
const FETCH_ADD_INTERFACE_HEADER_VALUE = '/addInterface/FETCH_ADD_INTERFACE_HEADER_VALUE';
const ADD_INTERFACE_SEQ_HEADER = '/addInterface/ADD_INTERFACE_SEQ_HEADER';
const DELETE_INTERFACE_SEQ_HEADER = '/addInterface/DELETE_INTERFACE_SEQ_HEADER';
const GET_INTERFACE_REQ_PARAMS = '/addInterface/GET_INTERFACE_REQ_PARAMS';
const GET_INTERFACE_RES_PARAMS = '/addInterface/GET_INTERFACE_RES_PARAMS';
const PUSH_INTERFACE_NAME = '/addInterface/PUSH_INTERFACE_NAME';
const PUSH_INTERFACE_METHOD = '/addInterface/PUSH_INTERFACE_METHOD';
const FETCH_INTERFACE_PROJECT = '/addInterface/FETCH_INTERFACE_PROJECT';
const ADD_INTERFACE_CLIPBOARD = '/addInterface/ADD_INTERFACE_CLIPBOARD';
