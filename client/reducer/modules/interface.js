...
// Actions
const INIT_INTERFACE_DATA = 'mock/interface/INIT_INTERFACE_DATA';
const FETCH_INTERFACE_DATA = 'mock/interface/FETCH_INTERFACE_DATA';
const FETCH_INTERFACE_LIST_MENU = 'mock/interface/FETCH_INTERFACE_LIST_MENU';
const DELETE_INTERFACE_DATA = 'mock/interface/DELETE_INTERFACE_DATA';
const DELETE_INTERFACE_CAT_DATA = 'mock/interface/DELETE_INTERFACE_CAT_DATA';
const UPDATE_INTERFACE_DATA = 'mock/interface/UPDATE_INTERFACE_DATA';
const CHANGE_EDIT_STATUS = 'mock/interface/CHANGE_EDIT_STATUS';
const FETCH_INTERFACE_LIST = 'mock/interface/FETCH_INTERFACE_LIST';
const SAVE_IMPORT_DATA = 'mock/interface/SAVE_IMPORT_DATA';
const FETCH_INTERFACE_CAT_LIST = 'mock/interface/FETCH_INTERFACE_CAT_LIST'
// const SAVE_INTERFACE_PROJECT_ID = 'mock/interface/SAVE_INTERFACE_PROJECT_ID';
// const GET_INTERFACE_GROUP_LIST = 'mock/interface/GET_INTERFACE_GROUP_LIST';
