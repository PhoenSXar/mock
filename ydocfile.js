module.exports = {
    ...
    "common": { // 通用默认配置，包括主页配置等
        "title": "接口管理平台", //page title
        "footer": "&copy; 2018 <a href=\"https://ymfe.org\">YMFE</a> Team. Build by <a href=\"http://ued.qunar.com/ydoc/\">ydoc</a>&nbsp;", // 通用尾
        "home": '<img src="./images/logo_header@2x.png" /> &nbsp;Lemonce Mock Server', 
        "homeUrl": "./index.html", 
        "keywords": "api管理,接口管理,接口文档,api文档",
        "description": "旨在为开发、产品、测试人员提供更优雅的接口管理服务。可以帮助开发者轻松创建、发布、维护 API，还为用户提供了优秀的交互体验，开发人员只需利用平台提供的接口数据写入工具以及简单的点击操作就可以实现接口的管理。"
    },
    "options": {
        "foldcode": false,
    ...
    "pages": [
        {
            ...
            "homepage": { // 配置首页，样式区别于其他页面
                ...
                "intro": [{ // 首页的正文部分，数组项依次渲染，可重复使用
                    ...
                    "desc": "让接口开发更简单高效，让接口的管理更具可读性、可维护性，让团队协作更合理。" // 介绍板块描述
                },{
                    "title": "",
                    "detail": {
                        ...
                        "content": [{ // 三列布局的内容，每项的key值非必需，但建议每列的key值一致
                            ...
                            "desc": "成熟的团队管理<br>扁平化项目权限配置满足各类企业的需求" // 描述
                        },{
                            "name": "接口管理",
            ...
            "banner": {
                ...
                <span class="name"> Lemonce Mock Server </span></div>`,
